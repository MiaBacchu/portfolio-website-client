...
const AboutHeader = () => {
    return (
        ...
        <Grid container justifyContent='center'>
            <Grid xs={11} md={5.5} sx={{marginX:'1rem', marginBottom:'5rem'}}>
        <Image style={{borderRadius:'1rem'}} src='https://i.ibb.co/4WDDtMw/DSC-0027-1.jpg'></Image>
        </Grid>
        <Grid xs={11} md={5.5} sx={{marginX:'1rem', marginBottom:'5rem', wordBreak:'break-words',py:'1rem',px:'1rem'}}>
        ...
        <Grid xs={11} md={5.5} sx={{marginX:'1rem',backgroundColor:'#8A2BE2',marginBottom:'5rem',wordBreak:'break-all',py:'2rem',px:'1rem',borderRadius:'1rem'}}>
